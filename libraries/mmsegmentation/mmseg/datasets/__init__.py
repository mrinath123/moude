...
from .cityscapesC import CityCDataset
from .synthetic_rain import SynDataset
# yapf: disable
...
__all__ = [
    ...
    'PascalContextDataset', 'PascalContextDataset59', 'ChaseDB1Dataset','ACDCDataset','CityCDataset','SynDataset',
