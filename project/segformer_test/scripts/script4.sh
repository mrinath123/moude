...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=29578  tools/train_lora_ft.py local_config/my_models/syn_100_cotta.py --launcher pytorch ${@:3}
