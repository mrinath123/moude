...
python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=29578  tools/train.py local_config/my_models/syn_rain_200_lora_ft.py --launcher pytorch ${@:3}
