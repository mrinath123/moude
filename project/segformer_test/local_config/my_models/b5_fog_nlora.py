...
checkpoint_path = '/BS/DApt/work/project/segformer_test/pretrained/segformer_mit-b5_8x1_1024x1024_160k_cityscapes_20211206_072934-87a052ec.pth'
crop_size = (960, 540)
train_batch = 2
val_batch = 1
lr = 0.0005
...
val_begin = 0
log_interval = 50
#custom_imports = dict(imports=['idass'], allow_failed_imports=False)
# model settings
