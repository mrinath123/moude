...
_base_ = [
    '../_base_/datasets/acdc_rain.py',
    '../_base_/ida/ida.py',
    '../_base_/default_runtime.py'
]


checkpoint_path = '/BS/DApt/work/project/segformer_test/pretrained/vpt_idass.pth'
crop_size = (960, 540)
train_batch = 2
val_batch = 2
lr = 1e-5
...
optim_wrapper = dict(
    ...
    clip_grad=dict(max_norm=1.0)  # Added comma before this line
)

# learning policy
param_scheduler = [
    dict(
        type='LinearLR', start_factor=5e-7, by_epoch=False, begin=0, end=3500),
    dict(
        type='PolyLR',
        eta_min=0.0,
        power=1.0,
