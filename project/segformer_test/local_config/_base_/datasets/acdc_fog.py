...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='rgb_anon_trainvaltest/rgb_anon/fog/train', seg_map_path='gt_trainval/gt/fog/train'), 
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='rgb_anon_trainvaltest/rgb_anon/fog/val', seg_map_path='gt_trainval/gt/fog/val'),
