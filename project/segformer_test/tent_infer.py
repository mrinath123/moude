...
def load_model(config_path):
    pretrained = '/BS/DApt/work/project/segformer_test/work_dirs/tentv5/fog_v2_20k_0.6942_200.pth'
    ...
    encdec.eval()
    encdec.cuda()
    encdec.requires_grad_(False)  # Set requires_grad to False
